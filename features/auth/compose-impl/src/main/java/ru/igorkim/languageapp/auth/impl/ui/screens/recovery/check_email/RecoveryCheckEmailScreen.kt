package ru.igorkim.languageapp.auth.impl.ui.screens.recovery.check_email
...
internal fun RecoveryCheckEmailScreen(
    ...
    Column(
        ...
        Image(
            imageVector = ImageVector.vectorResource(ru.igorkim.languageapp.core.design.R.drawable.ic_round_check_24),
