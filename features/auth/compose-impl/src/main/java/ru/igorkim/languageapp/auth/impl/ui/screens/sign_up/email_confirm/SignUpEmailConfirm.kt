package ru.igorkim.languageapp.auth.impl.ui.screens.sign_up.email_confirm
...
internal fun SignUpEmailConfirmScreen(
    ...
    Column(
        ...
        Text(
            text = stringResource(ru.igorkim.languageapp.auth.impl.R.string.signup_waiting_for_email_confirm),
        ...
        Text(
            text = stringResource(ru.igorkim.languageapp.auth.impl.R.string.signup_email_confirm_description),
            textAlign = TextAlign.Center,
            fontWeight = FontWeight.Medium,
